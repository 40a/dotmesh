...
docker push $(hostname).local:80/datamesh-io/etcd:v3.0.15
...
docker build -t $(hostname).local:80/datamesh-io/etcd-browser:v1 .
docker push $(hostname).local:80/datamesh-io/etcd-browser:v1
